# mms_master
This is MMS project for Master code for RS232(Slave).

## Getting started
- v.1.0.0  The default code version.
- v.1.1.0  Add function Subscribe data and maintain coding.
...
/*----- SMM-002(ESP32S2) and SMM-002A(EPS32S3) ----*/
...
- Example: data/mst/demo/mc01, alarm/mst/demo/mc01
...
/*----------------------------------------------------------------------------*/
MicMMS aaa("MIC_Iot", "Micdev@2024", "192.168.0.201", 1883, "/mst/demo/", "mc01", 1, Serial1, "192.168.0.101", "192.168.0.1", "255.255.255.0", "2.0.3");  //MIC are test
