# master_tcp
This is MMS project for Master code for EthernetTCP(LAN)(Slave).
...
- Example: data/mic/test/mc01r, alarm/mic/test/mc01r
...
## The Modbus TCP connection cannot be checked.
As follows

- Connection the LAN cable from GOT to the IIoT Box
- Assign the address at the IIoT Box to "192.168.3.19" to receive data from GOT
- The range of Address of the Register type is not covered
